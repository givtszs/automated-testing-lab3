...
describe("gauss_functions", () => {
    ...
    describe("gauss_forward", () => {
        it("performs gauss forward elimination when the pivot element is non-zero", () => {
            const matrix = {
                get_rows: function () {},
                get_cols: function () {},
                get: function () {},
            ...
            matrixMock.expects('get_rows').once().returns(2);
            matrixMock.expects('get_cols').once().returns(3);
        ...
        it("performs row swap when the pivot element is zero", () => {
            const matrix = {
                get_rows: function () {},
                get_cols: function () {},
                get: function () {},
            ...
            matrixMock.expects('get_rows').once().returns(2);
            matrixMock.expects('get_cols').once().returns(3);
            matrixMock.expects('get').withArgs(0, 0).atLeast(1).returns(0); 
            matrixMock.expects('swap_with_nonzero_row').withArgs(0).once();
            matrixMock.expects('mull_add').never();
    ...
    describe('write_in_file', () => {
        ...
        it('should append the list values to the file when list_name is valid', () => {
        ...
        it('should write "no solution" to the file when list_name is null', () => {
            readFileSyncStub.returns("2\n1 2 3\n4 5 6\n");
        ...
        it('should write "wrong input" to the file when check_input returns false', () => {
